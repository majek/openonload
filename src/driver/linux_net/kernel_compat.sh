...
EFX_NEED_WARN_ONCE			nsymbol	WARN_ONCE		include/asm-generic/bug.h
...
EFX_HAVE_OLD_NLA64			nsymbol	nla_put_u64_64bit	include/net/netlink.h
...
EFX_HAVE_LINUX_LOG2_H           file                include/linux/log2.h
