...
#define EFX_DRIVER_VERSION	"3.2.1.6099"
...
#if defined(EFX_NOT_UPSTREAM) && defined(EFX_HAVE_VLAN_RX_PATH) && !defined(__VMKLNX__)
 ...
 *	and efx_nic_test_registers(), and is expected to reset the NIC.
