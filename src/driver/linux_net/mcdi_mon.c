...
#define SENSOR(name, label, hwmon_type, port)			\
	...
	SENSOR(CONTROLLER_TEMP,	   "Controller board temp.",EFX_HWMON_TEMP,-1),
	SENSOR(PHY_COMMON_TEMP,	   "PHY temp.",		   EFX_HWMON_TEMP, -1),
	SENSOR(CONTROLLER_COOLING, "Controller heat sink", EFX_HWMON_COOL, -1),
	SENSOR(PHY0_TEMP,	   "PHY temp.",		   EFX_HWMON_TEMP, 0),
	SENSOR(PHY0_COOLING,	   "PHY heat sink",	   EFX_HWMON_COOL, 0),
	SENSOR(PHY1_TEMP,	   "PHY temp.",		   EFX_HWMON_TEMP, 1),
	SENSOR(PHY1_COOLING,	   "PHY heat sink",	   EFX_HWMON_COOL, 1),
	...
	SENSOR(OUT_VAOE,	   "AOE FPGA supply",	   EFX_HWMON_IN,   -1),
	SENSOR(AOE_TEMP,	   "AOE FPGA temp.",	   EFX_HWMON_TEMP, -1),
	SENSOR(PSU_AOE_TEMP,	   "AOE regulator temp.",  EFX_HWMON_TEMP, -1),
	SENSOR(PSU_TEMP,	   "Controller regulator temp.",
							   EFX_HWMON_TEMP, -1),
	SENSOR(FAN_0,		   "Fan 0",		   EFX_HWMON_COOL, -1),
	SENSOR(FAN_1,		   "Fan 1",		   EFX_HWMON_COOL, -1),
	SENSOR(FAN_2,		   "Fan 2",		   EFX_HWMON_COOL, -1),
	SENSOR(FAN_3,		   "Fan 3",		   EFX_HWMON_COOL, -1),
	SENSOR(FAN_4,		   "Fan 4",		   EFX_HWMON_COOL, -1),
	...
	SENSOR(IN_0V9,		   "0.9V supply",	   EFX_HWMON_IN,   -1),
	SENSOR(IN_I0V9,		   "0.9V supply current",  EFX_HWMON_CURR, -1),
	SENSOR(IN_I1V2,		   "1.2V supply current",  EFX_HWMON_CURR, -1),
	SENSOR(IN_0V9_ADC,	   "0.9V supply (ext. ADC)",EFX_HWMON_IN,  -1),
	SENSOR(CONTROLLER_2_TEMP,  "Controller board temp. 2",EFX_HWMON_TEMP,-1),
	SENSOR(VREG_INTERNAL_TEMP, "Regulator die temp.",  EFX_HWMON_TEMP, -1),
	SENSOR(VREG_0V9_TEMP,	   "0.9V regulator temp.", EFX_HWMON_TEMP, -1),
	SENSOR(VREG_1V2_TEMP,	   "1.2V regulator temp.", EFX_HWMON_TEMP, -1),
	/* There is such a thing as too much information... */
	SENSOR(CONTROLLER_VPTAT, "Controller PTAT voltage (int. ADC)",
							   EFX_HWMON_IN,   -1),
	SENSOR(CONTROLLER_INTERNAL_TEMP, "Controller die temp. (int. ADC)",
							   EFX_HWMON_TEMP, -1),
	SENSOR(CONTROLLER_VPTAT_EXTADC, "Controller PTAT voltage (ext. ADC)",
							   EFX_HWMON_IN,   -1),
	SENSOR(CONTROLLER_INTERNAL_TEMP_EXTADC,
	       "Controller die temp. (ext. ADC)",	   EFX_HWMON_TEMP, -1),
	SENSOR(AMBIENT_TEMP,	   "Ambient temp.",	   EFX_HWMON_TEMP, -1),
	SENSOR(AIRFLOW,		   "Air flow raw",	   EFX_HWMON_IN,   -1),
	SENSOR(VDD08D_VSS08D_CSR,  "0.9V die (int. ADC)",  EFX_HWMON_IN,   -1),
	SENSOR(VDD08D_VSS08D_CSR_EXTADC,"0.9V die (ext. ADC)",EFX_HWMON_IN,-1),
	SENSOR(HOTPOINT_TEMP,	   "Controller board temp. (hotpoint)",
							   EFX_HWMON_TEMP, -1),
#undef SENSOR
};
