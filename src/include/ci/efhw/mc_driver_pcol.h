...
#define MC_CMD_0x12c_PRIVILEGE_CTG SRIOV_CTG_ADMIN
...
/* enum: Adapter Authentication Certificate (AAC). The AAC is used to verify
 * the authenticity of the adapter.
 */
#define          MC_CMD_GET_CERTIFICATE_IN_AAC  0x1
/* enum: Adapter Authentication Signing Certificate (AASC). The AASC is used to
 * verify the validity of AAC.
 */
#define          MC_CMD_GET_CERTIFICATE_IN_AASC  0x2
/* enum: Customer adapter authentication certificate. */
