...
#define    FCDI_EXTENDED_EVENT_PPS_LEN(num) (8+umul(8,(num)))
...
#define          MUM_EVENT_PORT_PHY_SRC_DATA_ID_STATE 0x4 /* enum */
#define          MUM_EVENT_PORT_PHY_SRC_DATA_ID_MAX 0x5 /* enum */
...
#define    MC_CMD_READ32_OUT_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_WRITE32_IN_LEN(num) (4+umul(4,(num)))
...
#define    MC_CMD_FC_IN_WRITE32_LEN(num) (12+umul(4,(num)))
/*            MC_CMD_FC_IN_CMD_OFST 0 */
...
#define    MC_CMD_FC_IN_IO_REL_WRITE32_LEN(num) (16+umul(4,(num)))
/*            MC_CMD_FC_IN_CMD_OFST 0 */
/*            MC_CMD_FC_IN_IO_REL_HEADER_OFST 4 */
...
#define    MC_CMD_FC_IN_SPI_WRITE_LEN(num) (12+umul(4,(num)))
/*            MC_CMD_FC_IN_CMD_OFST 0 */
...
#define    MC_CMD_FC_OUT_READ32_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_FC_OUT_IO_REL_READ32_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_FC_OUT_DMA_READ_LEN(num) (0+umul(1,(num)))
/* The data read */
...
#define    MC_CMD_FC_OUT_TIMESTAMP_READ_SNAPSHOT_LEN(num) (0+umul(8,(num)))
...
#define    MC_CMD_FC_OUT_SPI_READ_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_AOE_IN_JTAG_WRITE_LEN(num) (8+umul(4,(num)))
/*            MC_CMD_AOE_IN_CMD_OFST 0 */
...
#define    MC_CMD_AOE_OUT_FAN_FAILURES_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_AOE_OUT_GET_PHY_MEDIA_INFO_LEN(num) (4+umul(1,(num)))
/* in bytes */
...
#define    MC_CMD_AOE_OUT_JTAG_WRITE_LEN(num) (8+umul(4,(num)))
...
#define    MC_CMD_AOE_OUT_DDR_LEN(num) (16+umul(1,(num)))
...
#define    MC_CMD_PTP_IN_TRANSMIT_LEN(num) (12+umul(1,(num)))
/*            MC_CMD_PTP_IN_CMD_OFST 0 */
/*            MC_CMD_PTP_IN_PERIPH_ID_OFST 4 */
...
#define    MC_CMD_PTP_IN_FPGAWRITE_LEN(num) (12+umul(1,(num)))
/*            MC_CMD_PTP_IN_CMD_OFST 0 */
/*            MC_CMD_PTP_IN_PERIPH_ID_OFST 4 */
...
#define    MC_CMD_PTP_OUT_SYNCHRONIZE_LEN(num) (0+umul(20,(num)))
...
#define    MC_CMD_PTP_OUT_FPGAREAD_LEN(num) (0+umul(1,(num)))
...
#define    MC_CMD_CSR_READ32_OUT_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_CSR_WRITE32_IN_LEN(num) (8+umul(4,(num)))
/* Address */
...
#define    MC_CMD_STACKINFO_OUT_LEN(num) (0+umul(12,(num)))
...
#define    MC_CMD_DBI_WRITE_IN_LEN(num) (0+umul(12,(num)))
...
#define    MC_CMD_GET_BOARD_CFG_OUT_LEN(num) (72+umul(2,(num)))
...
#define    MC_CMD_DBI_READX_IN_LEN(num) (0+umul(8,(num)))
...
#define    MC_CMD_DBI_READX_OUT_LEN(num) (0+umul(4,(num)))
/* Value */
...
#define    MC_CMD_LTSSM_HIST_OUT_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_PUTS_IN_LEN(num) (12+umul(1,(num)))
...
#define    MC_CMD_FLUSH_RX_QUEUES_IN_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_MEMCPY_IN_LEN(num) (0+umul(32,(num)))
...
#define    MC_CMD_NVRAM_READ_OUT_LEN(num) (0+umul(1,(num)))
...
#define    MC_CMD_NVRAM_WRITE_IN_LEN(num) (12+umul(1,(num)))
...
#define    MC_CMD_SCHEDINFO_OUT_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_SENSOR_INFO_OUT_LEN(num) (4+umul(8,(num)))
...
#define    MC_CMD_SENSOR_INFO_EXT_OUT_LEN(num) (4+umul(8,(num)))
...
#define    MC_CMD_ADD_LIGHTSOUT_OFFLOAD_IN_LEN(num) (4+umul(4,(num)))
...
#define    MC_CMD_GET_PHY_MEDIA_INFO_OUT_LEN(num) (4+umul(1,(num)))
/* in bytes */
...
#define    MC_CMD_NVRAM_PARTITIONS_OUT_LEN(num) (4+umul(4,(num)))
...
#define    MC_CMD_NVRAM_METADATA_OUT_LEN(num) (20+umul(1,(num)))
/* Partition type ID code */
...
#define    MC_CMD_MUM_IN_WRITE_LEN(num) (12+umul(4,(num)))
/* MUM cmd header */
/*            MC_CMD_MUM_IN_CMD_OFST 0 */
...
#define    MC_CMD_MUM_IN_RAW_CMD_LEN(num) (16+umul(1,(num)))
/* MUM cmd header */
/*            MC_CMD_MUM_IN_CMD_OFST 0 */
/* MUM I2C cmd code */
...
#define    MC_CMD_MUM_OUT_RAW_CMD_LEN(num) (0+umul(1,(num)))
/* returned data */
...
#define    MC_CMD_MUM_OUT_READ_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_MUM_OUT_READ_SENSORS_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_MUM_OUT_QSFP_GET_MEDIA_INFO_LEN(num) (4+umul(1,(num)))
/* in bytes */
...
#define    MC_CMD_INIT_EVQ_IN_LEN(num) (36+umul(8,(num)))
/* Size, in entries */
...
#define    MC_CMD_INIT_RXQ_IN_LEN(num) (28+umul(8,(num)))
/* Size, in entries */
...
#define    MC_CMD_INIT_TXQ_IN_LEN(num) (28+umul(8,(num)))
/* Size, in entries */
...
#define    MC_CMD_PROGRAM_BUFTBL_ENTRIES_IN_LEN(num) (12+umul(8,(num)))
...
#define    MC_CMD_GET_PARSER_DISP_INFO_OUT_LEN(num) (8+umul(4,(num)))
/* identifies the type of operation requested */
...
#define    MC_CMD_SATELLITE_DOWNLOAD_IN_LEN(num) (16+umul(4,(num)))
...
#define    MC_CMD_VPORT_GET_MAC_ADDRESSES_OUT_LEN(num) (4+umul(6,(num)))
...
#define    MC_CMD_DUMP_BUFTBL_ENTRIES_OUT_LEN(num) (0+umul(12,(num)))
...
#define    MC_CMD_CAP_BLK_READ_OUT_LEN(num) (0+umul(8,(num)))
...
#define    MC_CMD_UART_SEND_DATA_OUT_LEN(num) (16+umul(1,(num)))
...
#define    MC_CMD_UART_RECV_DATA_IN_LEN(num) (16+umul(1,(num)))
...
#define    MC_CMD_READ_FUSES_OUT_LEN(num) (4+umul(1,(num)))
...
#define    MC_CMD_KR_TUNE_IN_LEN(num) (4+umul(4,(num)))
/* Requested operation */
...
#define    MC_CMD_KR_TUNE_RXEQ_GET_OUT_LEN(num) (0+umul(4,(num)))
/* RXEQ Parameter */
...
#define    MC_CMD_KR_TUNE_RXEQ_SET_IN_LEN(num) (4+umul(4,(num)))
/* Requested operation */
...
#define    MC_CMD_KR_TUNE_TXEQ_GET_OUT_LEN(num) (0+umul(4,(num)))
/* TXEQ Parameter */
...
#define    MC_CMD_KR_TUNE_TXEQ_SET_IN_LEN(num) (4+umul(4,(num)))
/* Requested operation */
...
#define    MC_CMD_KR_TUNE_POLL_EYE_PLOT_OUT_LEN(num) (0+umul(2,(num)))
...
#define    MC_CMD_PCIE_TUNE_IN_LEN(num) (4+umul(4,(num)))
/* Requested operation */
...
#define    MC_CMD_PCIE_TUNE_RXEQ_GET_OUT_LEN(num) (0+umul(4,(num)))
/* RXEQ Parameter */
...
#define    MC_CMD_PCIE_TUNE_TXEQ_GET_OUT_LEN(num) (0+umul(4,(num)))
/* RXEQ Parameter */
...
#define    MC_CMD_PCIE_TUNE_POLL_EYE_PLOT_OUT_LEN(num) (0+umul(2,(num)))
...
#define    MC_CMD_LICENSED_APP_OP_IN_LEN(num) (8+umul(4,(num)))
/* application ID */
...
#define    MC_CMD_LICENSED_APP_OP_OUT_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_SET_PARSER_DISP_CONFIG_IN_LEN(num) (8+umul(4,(num)))
...
#define    MC_CMD_GET_PARSER_DISP_CONFIG_OUT_LEN(num) (0+umul(4,(num)))
