...
/*------------------------------------------------------------*/
/*
 * PCR_AC_PM_CAP_REG(16bit):
 * Power management capabilities register
 */
#define	PCR_AC_PM_CAP_REG 0x00000042
/* falcona0,falconb0,sienaa0=pci_f0_config */
/*
 * PCR_DZ_PM_CAP_REG(16bit):
 * Power management capabilities register
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_AC_PM_CS_REG(16bit):
 * Power management control & status register
 */
#define	PCR_AC_PM_CS_REG 0x00000044
/* falcona0,falconb0,sienaa0=pci_f0_config */
/*
 * PCR_DZ_PM_CS_REG(16bit):
 * Power management control & status register
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_AC_MSI_CAP_ID_REG(8bit):
 * MSI capability ID
 */
#define	PCR_AC_MSI_CAP_ID_REG 0x00000050
/* falcona0,falconb0,sienaa0=pci_f0_config */
/*
 * PCR_DZ_MSI_CAP_ID_REG(8bit):
 * MSI capability ID
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_AC_MSI_CTL_REG(16bit):
 * MSI control register
 */
#define	PCR_AC_MSI_CTL_REG 0x00000052
/* falcona0,falconb0,sienaa0=pci_f0_config */
/*
 * PCR_DZ_MSI_CTL_REG(16bit):
 * MSI control register
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_AC_MSI_DAT_REG(16bit):
 * MSI data register
 */
#define	PCR_AC_MSI_DAT_REG 0x0000005c
/* falcona0,falconb0,sienaa0=pci_f0_config */
/*
 * PCR_DZ_MSI_DAT_REG(16bit):
 * MSI data register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_PCIE_CAP_LIST_REG(16bit):
 * PCIe capability list register
 */
#define	PCR_CC_PCIE_CAP_LIST_REG 0x00000070
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_PCIE_CAP_LIST_REG(16bit):
 * PCIe capability list register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_PCIE_CAP_REG(16bit):
 * PCIe capability register
 */
#define	PCR_CC_PCIE_CAP_REG 0x00000072
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_PCIE_CAP_REG(16bit):
 * PCIe capability register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_DEV_CAP_REG(28bit):
 * PCIe device capabilities register
 */
#define	PCR_CC_DEV_CAP_REG 0x00000074
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_DEV_CAP_REG(32bit):
 * PCIe device capabilities register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_DEV_CTL_REG(16bit):
 * PCIe device control register
 */
#define	PCR_CC_DEV_CTL_REG 0x00000078
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_DEV_CTL_REG(16bit):
 * PCIe device control register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_DEV_STAT_REG(16bit):
 * PCIe device status register
 */
#define	PCR_CC_DEV_STAT_REG 0x0000007a
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_DEV_STAT_REG(16bit):
 * PCIe device status register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_LNK_CAP_REG(32bit):
 * PCIe link capabilities register
 */
#define	PCR_CC_LNK_CAP_REG 0x0000007c
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_LNK_CAP_REG(32bit):
 * PCIe link capabilities register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_LNK_CTL_REG(16bit):
 * PCIe link control register
 */
#define	PCR_CC_LNK_CTL_REG 0x00000080
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_LNK_CTL_REG(16bit):
 * PCIe link control register
 */
...
/* falcona0,falconb0=pci_f0_config */
/*
 * PCR_CC_LNK_STAT_REG(16bit):
 * PCIe link status register
 */
#define	PCR_CC_LNK_STAT_REG 0x00000082
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_LNK_STAT_REG(16bit):
 * PCIe link status register
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_LNK_CTL2_REG(16bit):
 * PCIe Link Control 2
 */
#define	PCR_CC_LNK_CTL2_REG 0x000000a0
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_LNK_CTL2_REG(16bit):
 * PCIe Link Control 2
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_LNK_STAT2_REG(16bit):
 * PCIe Link Status 2
 */
#define	PCR_CC_LNK_STAT2_REG 0x000000a2
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_LNK_STAT2_REG(16bit):
 * PCIe Link Status 2
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_DEVSN_DWORD1_REG(32bit):
 * Device serial number DWORD0
 */
#define	PCR_DZ_DEVSN_DWORD1_REG 0x00000138
/* hunta0=pci_f0_config */
/*
 * PCR_CC_DEVSN_DWORD1_REG(32bit):
 * Device serial number DWORD0
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_ARI_CAP_REG(16bit):
 * ARI Capabilities
 */
#define	PCR_DZ_ARI_CAP_REG 0x00000144
/* hunta0=pci_f0_config */
/*
 * PCR_CC_ARI_CAP_REG(16bit):
 * ARI Capabilities
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_ARI_CTL_REG(16bit):
 * ARI Control
 */
#define	PCR_DZ_ARI_CTL_REG 0x00000146
/* hunta0=pci_f0_config */
/*
 * PCR_CC_ARI_CTL_REG(16bit):
 * ARI Control
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_CAP_REG(32bit):
 * SRIOV Capabilities
 */
#define	PCR_CC_SRIOV_CAP_REG 0x00000164
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_CAP_REG(32bit):
 * SRIOV Capabilities
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_CTL_REG(16bit):
 * SRIOV Control
 */
#define	PCR_CC_SRIOV_CTL_REG 0x00000168
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_CTL_REG(16bit):
 * SRIOV Control
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_STAT_REG(16bit):
 * SRIOV Status
 */
#define	PCR_CC_SRIOV_STAT_REG 0x0000016a
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_STAT_REG(16bit):
 * SRIOV Status
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_INITIALVFS_REG(16bit):
 * SRIOV Initial VFs
 */
#define	PCR_CC_SRIOV_INITIALVFS_REG 0x0000016c
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_INITIALVFS_REG(16bit):
 * SRIOV Initial VFs
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_TOTALVFS_REG(10bit):
 * SRIOV Total VFs
 */
#define	PCR_CC_SRIOV_TOTALVFS_REG 0x0000016e
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_TOTALVFS_REG(10bit):
 * SRIOV Total VFs
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_NUMVFS_REG(16bit):
 * SRIOV Number of VFs
 */
#define	PCR_CC_SRIOV_NUMVFS_REG 0x00000170
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_NUMVFS_REG(16bit):
 * SRIOV Number of VFs
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_1STVF_OFFSET_REG(16bit):
 * SRIOV First VF Offset
 */
#define	PCR_CC_SRIOV_1STVF_OFFSET_REG 0x00000174
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_1STVF_OFFSET_REG(16bit):
 * SRIOV First VF Offset
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_VFSTRIDE_REG(16bit):
 * SRIOV VF Stride
 */
#define	PCR_CC_SRIOV_VFSTRIDE_REG 0x00000176
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_VFSTRIDE_REG(16bit):
 * SRIOV VF Stride
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_DEVID_REG(16bit):
 * SRIOV VF Device ID
 */
#define	PCR_CC_SRIOV_DEVID_REG 0x0000017a
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_DEVID_REG(16bit):
 * SRIOV VF Device ID
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_BAR0_REG(32bit):
 * SRIOV VF Bar0
 */
#define	PCR_CC_SRIOV_BAR0_REG 0x00000184
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_BAR0_REG(32bit):
 * SRIOV VF Bar0
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_BAR1_REG(32bit):
 * SRIOV Bar1
 */
#define	PCR_CC_SRIOV_BAR1_REG 0x00000188
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_BAR1_REG(32bit):
 * SRIOV Bar1
 */
#define	PCR_DZ_SRIOV_BAR1_REG 0x00000228
/* hunta0=pci_f0_config */

/* defined as PCRF_CC_VF_BAR_ADDRESS_LBN 0; access=rw reset=0x0 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_BAR2_REG(32bit):
 * SRIOV Bar2
 */
#define	PCR_CC_SRIOV_BAR2_REG 0x0000018c
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_BAR2_REG(32bit):
 * SRIOV Bar2
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_BAR3_REG(32bit):
 * SRIOV Bar3
 */
#define	PCR_CC_SRIOV_BAR3_REG 0x00000190
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_BAR3_REG(32bit):
 * SRIOV Bar3
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_BAR4_REG(32bit):
 * SRIOV Bar4
 */
#define	PCR_CC_SRIOV_BAR4_REG 0x00000194
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_BAR4_REG(32bit):
 * SRIOV Bar4
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SRIOV_BAR5_REG(32bit):
 * SRIOV Bar5
 */
#define	PCR_CC_SRIOV_BAR5_REG 0x00000198
/* sienaa0=pci_f0_config */
/*
 * PCR_DZ_SRIOV_BAR5_REG(32bit):
 * SRIOV Bar5
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_LTR_MAX_SNOOP_REG(32bit):
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_LINK_CONTROL3_REG(32bit):
 * Link Control 3.
 */
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_LANE_ERROR_STAT_REG(32bit):
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_LANE01_EQU_CONTROL_REG(32bit):
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_LANE23_EQU_CONTROL_REG(32bit):
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_LANE45_EQU_CONTROL_REG(32bit):
...
/*------------------------------------------------------------*/
/*
 * PCR_DZ_LANE67_EQU_CONTROL_REG(32bit):
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_SYM_TMR_FLT_MSK_REG(16bit):
...
/*------------------------------------------------------------*/
/*
 * PCR_CC_VC0_NP_RQ_CTL_REG(32bit):
