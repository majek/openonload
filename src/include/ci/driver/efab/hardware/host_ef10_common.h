...
/*------------------------------------------------------------*/
/* ES_DL_MSG_BASE_REQ */
#define	ESF_DZ_DL_HW_REQ_BASE_REQ_MSG_DATA_LBN 4
#define	ESF_DZ_DL_HW_REQ_BASE_REQ_MSG_DATA_WIDTH 116
#define	ESF_DZ_DL_HW_REQ_BASE_CLIENT_ID_LBN 2
#define	ESF_DZ_DL_HW_REQ_BASE_CLIENT_ID_WIDTH 2
#define	ESE_DZ_DL_TX_DPCPU1_ID 2
#define	ESE_DZ_DL_TX_DPCPU0_ID 1
#define	ESE_DZ_DL_RX_DPCPU_ID 0
#define	ESF_DZ_DL_HW_REQ_BASE_SUBTYPE_LBN 0
#define	ESF_DZ_DL_HW_REQ_BASE_SUBTYPE_WIDTH 2
#define	ESE_DZ_DL_REQ_GP_RD 2
#define	ESE_DZ_DL_RESP_GP_RD 2
#define	ESE_DZ_DL_REQ_DSCR_FETCH 1
#define	ESE_DZ_DL_RESP_DSCR_FETCH 1
#define	ESE_DZ_DL_REQ_DSCR_PUSH 0
#define	ESE_DZ_DL_RESP_DSCR_PUSH 0


/*------------------------------------------------------------*/
/* ES_DL_MSG_BASE_RESP */
#define	ESF_DZ_DL_HW_RSP_BASE_RSP_MSG_DATA_LBN 4
#define	ESF_DZ_DL_HW_RSP_BASE_RSP_MSG_DATA_WIDTH 44
#define	ESF_DZ_DL_HW_RSP_BASE_CLIENT_ID_LBN 2
#define	ESF_DZ_DL_HW_RSP_BASE_CLIENT_ID_WIDTH 2
#define	ESE_DZ_DL_TX_DPCPU1_ID 2
#define	ESE_DZ_DL_TX_DPCPU0_ID 1
#define	ESE_DZ_DL_RX_DPCPU_ID 0
#define	ESF_DZ_DL_HW_RSP_BASE_SUBTYPE_LBN 0
#define	ESF_DZ_DL_HW_RSP_BASE_SUBTYPE_WIDTH 2
#define	ESE_DZ_DL_REQ_GP_RD 2
#define	ESE_DZ_DL_REQ_DSCR_FETCH 1
#define	ESE_DZ_DL_REQ_DSCR_PUSH 0
...
/*------------------------------------------------------------*/
/* ES_DL_MSG_DSCR_FETCH_REQ */
#define	ESF_DZ_DL_HW_REQ_FETCH_DC_RPTR_LBN 88
#define	ESF_DZ_DL_HW_REQ_FETCH_DC_RPTR_WIDTH 6
#define	ESF_DZ_DL_HW_REQ_FETCH_QID_LBN 76
#define	ESF_DZ_DL_HW_REQ_FETCH_QID_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_BASE_PAGE_ID_LBN 58
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_BASE_PAGE_ID_WIDTH 18
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_HW_RPTR_LBN 46
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_HW_RPTR_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_HW_WPTR_LBN 34
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_HW_WPTR_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_FETCH_OID_LBN 22
#define	ESF_DZ_DL_HW_REQ_FETCH_OID_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_FETCH_BIU_ARGS_LBN 8
#define	ESF_DZ_DL_HW_REQ_FETCH_BIU_ARGS_WIDTH 14
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_SIZE_LBN 5
#define	ESF_DZ_DL_HW_REQ_FETCH_DSCR_SIZE_WIDTH 3
#define	ESF_DZ_DL_HW_REQ_FETCH_IS_TX_LBN 4
#define	ESF_DZ_DL_HW_REQ_FETCH_IS_TX_WIDTH 1
#define	ESF_DZ_DL_HW_REQ_FETCH_CLIENT_ID_LBN 2
#define	ESF_DZ_DL_HW_REQ_FETCH_CLIENT_ID_WIDTH 2
#define	ESE_DZ_DL_TX_DPCPU1_ID 2
#define	ESE_DZ_DL_TX_DPCPU0_ID 1
#define	ESE_DZ_DL_RX_DPCPU_ID 0
#define	ESF_DZ_DL_HW_REQ_FETCH_SUBTYPE_LBN 0
#define	ESF_DZ_DL_HW_REQ_FETCH_SUBTYPE_WIDTH 2
#define	ESE_DZ_DL_REQ_GP_RD 2
#define	ESE_DZ_DL_REQ_DSCR_FETCH 1
#define	ESE_DZ_DL_REQ_DSCR_PUSH 0
...
/*------------------------------------------------------------*/
/* ES_DL_MSG_DSCR_FETCH_RESP */
#define	ESF_DZ_DL_HW_RSP_FETCH_FAIL_LBN 47
#define	ESF_DZ_DL_HW_RSP_FETCH_FAIL_WIDTH 1
#define	ESF_DZ_DL_HW_RSP_FETCH_QID_LBN 35
#define	ESF_DZ_DL_HW_RSP_FETCH_QID_WIDTH 12
#define	ESF_DZ_DL_HW_RSP_FETCH_NUM_DSCR_LOADED_LBN 28
#define	ESF_DZ_DL_HW_RSP_FETCH_NUM_DSCR_LOADED_WIDTH 7
#define	ESF_DZ_DL_HW_RSP_FETCH_REFL_DSCR_HW_WPTR_LBN 16
#define	ESF_DZ_DL_HW_RSP_FETCH_REFL_DSCR_HW_WPTR_WIDTH 12
#define	ESF_DZ_DL_HW_RSP_FETCH_NEW_DSCR_HW_RPTR_LBN 4
#define	ESF_DZ_DL_HW_RSP_FETCH_NEW_DSCR_HW_RPTR_WIDTH 12
#define	ESF_DZ_DL_HW_RSP_FETCH_CLIENT_ID_LBN 2
#define	ESF_DZ_DL_HW_RSP_FETCH_CLIENT_ID_WIDTH 2
#define	ESE_DZ_DL_TX_DPCPU1_ID 2
#define	ESE_DZ_DL_TX_DPCPU0_ID 1
#define	ESE_DZ_DL_RX_DPCPU_ID 0
#define	ESF_DZ_DL_HW_RSP_FETCH_SUBTYPE_LBN 0
#define	ESF_DZ_DL_HW_RSP_FETCH_SUBTYPE_WIDTH 2
#define	ESE_DZ_DL_REQ_GP_RD 2
#define	ESE_DZ_DL_REQ_DSCR_FETCH 1
#define	ESE_DZ_DL_REQ_DSCR_PUSH 0
...
/*------------------------------------------------------------*/
/* ES_DL_MSG_DSCR_PUSH_REQ */
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_LBN 56
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_WIDTH 64
#define	ESF_DZ_DL_HW_REQ_PUSH_QID_LBN 44
#define	ESF_DZ_DL_HW_REQ_PUSH_QID_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_HW_RPTR_LBN 32
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_HW_RPTR_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_HW_WPTR_LBN 20
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_HW_WPTR_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_PUSH_OID_LBN 8
#define	ESF_DZ_DL_HW_REQ_PUSH_OID_WIDTH 12
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_SIZE_LBN 5
#define	ESF_DZ_DL_HW_REQ_PUSH_DSCR_SIZE_WIDTH 3
#define	ESF_DZ_DL_HW_REQ_PUSH_IS_TX_LBN 4
#define	ESF_DZ_DL_HW_REQ_PUSH_IS_TX_WIDTH 1
#define	ESF_DZ_DL_HW_REQ_PUSH_CLIENT_ID_LBN 2
#define	ESF_DZ_DL_HW_REQ_PUSH_CLIENT_ID_WIDTH 2
#define	ESE_DZ_DL_TX_DPCPU1_ID 2
#define	ESE_DZ_DL_TX_DPCPU0_ID 1
#define	ESE_DZ_DL_RX_DPCPU_ID 0
#define	ESF_DZ_DL_HW_REQ_PUSH_SUBTYPE_LBN 0
#define	ESF_DZ_DL_HW_REQ_PUSH_SUBTYPE_WIDTH 2
#define	ESE_DZ_DL_REQ_GP_RD 2
#define	ESE_DZ_DL_REQ_DSCR_FETCH 1
#define	ESE_DZ_DL_REQ_DSCR_PUSH 0
...
/*------------------------------------------------------------*/
/* ES_DL_MSG_GP_RD_REQ */
#define	ESF_DZ_DL_HW_REQ_GPRD_SMC_ADDR_LBN 67
#define	ESF_DZ_DL_HW_REQ_GPRD_SMC_ADDR_WIDTH 17
#define	ESF_DZ_DL_HW_REQ_GPRD_HOST_ADDR_LBN 19
#define	ESF_DZ_DL_HW_REQ_GPRD_HOST_ADDR_WIDTH 48
#define	ESF_DZ_DL_HW_REQ_GPRD_BIU_ARGS_LBN 5
#define	ESF_DZ_DL_HW_REQ_GPRD_BIU_ARGS_WIDTH 14
#define	ESF_DZ_DL_HW_REQ_GPRD_IS_TX_LBN 4
#define	ESF_DZ_DL_HW_REQ_GPRD_IS_TX_WIDTH 1
#define	ESF_DZ_DL_HW_REQ_GPRD_CLIENT_ID_LBN 2
#define	ESF_DZ_DL_HW_REQ_GPRD_CLIENT_ID_WIDTH 2
#define	ESE_DZ_DL_TX_DPCPU1_ID 2
#define	ESE_DZ_DL_TX_DPCPU0_ID 1
#define	ESE_DZ_DL_RX_DPCPU_ID 0
#define	ESF_DZ_DL_HW_REQ_GPRD_SUBTYPE_LBN 0
#define	ESF_DZ_DL_HW_REQ_GPRD_SUBTYPE_WIDTH 2
#define	ESE_DZ_DL_REQ_GP_RD 2
#define	ESE_DZ_DL_REQ_DSCR_FETCH 1
#define	ESE_DZ_DL_REQ_DSCR_PUSH 0
...
/*------------------------------------------------------------*/
/* ES_DL_MSG_GP_RD_RESP */
#define	ESF_DZ_DL_HW_RSP_GPRD_FAIL_LBN 18
#define	ESF_DZ_DL_HW_RSP_GPRD_FAIL_WIDTH 1
#define	ESF_DZ_DL_HW_RSP_GPRD_BIU_ARGS_LBN 4
#define	ESF_DZ_DL_HW_RSP_GPRD_BIU_ARGS_WIDTH 14
#define	ESF_DZ_DL_HW_RSP_GPRD_CLIENT_ID_LBN 2
#define	ESF_DZ_DL_HW_RSP_GPRD_CLIENT_ID_WIDTH 2
#define	ESE_DZ_DL_TX_DPCPU1_ID 2
#define	ESE_DZ_DL_TX_DPCPU0_ID 1
#define	ESE_DZ_DL_RX_DPCPU_ID 0
#define	ESF_DZ_DL_HW_RSP_GPRD_SUBTYPE_LBN 0
#define	ESF_DZ_DL_HW_RSP_GPRD_SUBTYPE_WIDTH 2
#define	ESE_DZ_DL_REQ_GP_RD 2
#define	ESE_DZ_DL_REQ_DSCR_FETCH 1
#define	ESE_DZ_DL_REQ_DSCR_PUSH 0
