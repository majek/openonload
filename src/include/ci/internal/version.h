...
#define CI_MIN_RELEASE_VERSION            (2)
#define CI_MAINT_RELEASE_VERSION          (1)
#define CI_INCREMENTING_VERSION           (6082)
#define CI_VERSION_STRING                 "v3.2.1.6082"
